...
public class testScreen implements Screen, ApplicationListener {
    ...
    public testScreen(MyPDAGame game)
    {
    	this.pdagame = game;
    }
    ...
    public void create() {        
        ...
        new Thread(new Runnable(){
            ...
            public void run() {
                ...
                ServerSocket serverSocket = Gdx.net.newServerSocket(Protocol.TCP, 15536, serverSocketHint);
