...
//		testBounds = new Rectangle(500, 400, 300, 300);
	...
	private void updateSoldiers (float delta) 
	{
		...
		for (int i = 0; i < len; i++) 
		{
			...
			tower_blood += tower_blood += soldier.update(delta);
...
//		}
	...
	public boolean touchUp(int screenX, int screenY, int pointer, int button) {
		...
		henry.add(fighter16);		
		Soldier soldier1 = new Soldier(0,660,90,100,1,1);				
		soldier1s.add(soldier1);	
		Soldier soldier2 = new Soldier(0,660,90,400,1,3);				
		soldier2s.add(soldier2);
		Soldier soldier3 = new Soldier(0,660,90,1600,1,9);				
		soldier3s.add(soldier3);
		Soldier soldier4 = new Soldier(0,660,120,6400,1,27);				
		soldier4s.add(soldier4);
		Soldier soldier5 = new Soldier(0,660,150,25600,1,81);				
		soldier5s.add(soldier5);
		Soldier soldier6 = new Soldier(0,660,180,65000,1,400);				
		soldier6s.add(soldier6);
		Soldier soldier7 = new Soldier(0,660,210,140000,1,729);				
		soldier7s.add(soldier7);
		Soldier soldier8 = new Soldier(0,660,240,250000,1,900);				
		soldier8s.add(soldier8);
		Soldier soldier9 = new Soldier(0,660,270,600000,1,2500);				
		soldier9s.add(soldier9);
		Soldier soldier10 = new Soldier(0,660,300,2000000,1,7000);				
		soldier10s.add(soldier10);
		Soldier soldier11 = new Soldier(0,660,330,4200000,1,40000);				
		soldier11s.add(soldier11);
		Soldier soldier12 = new Soldier(0,660,360,3,1,1);				
		soldier12s.add(soldier12);
		Soldier soldier13 = new Soldier(0,660,390,3,1,1);				
		soldier13s.add(soldier13);
		Soldier soldier14 = new Soldier(0,660,420,3,1,1);				
		soldier14s.add(soldier14);
		Soldier soldier15 = new Soldier(0,660,450,3,1,1);				
		soldier15s.add(soldier15);
		Soldier soldier16 = new Soldier(0,660,480,3,1,1);				
		soldier16s.add(soldier16);
